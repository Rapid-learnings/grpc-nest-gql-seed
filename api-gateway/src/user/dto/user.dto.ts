...
export class ListUsersDto {
  ...
  @Field({ nullable: true, description: "enter user's metamask_id" })
  @IsOptional()
  @IsString()
...
export class UpdatePlatformConstantDto {
  @Field((type) => Int, {
    nullable: true,
    description: 'enter Direct marketplace Distribution to VRYNT Proceeds pool',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Direct Marketplace Ditribution to Artists Proceeds Pool',
  })
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Consumer Marketplace Distribution to VRYNT Proceeds Pool components',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Consumer Marketplace Distribution to Artists Proceeds Pool components',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Consumer Marketplace Distribution to VRYNT Proceeds Pool',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Consumer marketplace Distribution to Artist Proceeds pool NFT',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      'enter Consumer marketplace Distribution to Previous Collector Proceeds pool NFT',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description: 'enter Market Liquidity Bootstrap Pool',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description: 'enter Early gallery rewart claim',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description:
      ' enter VRYNT Credit to VRYNT Conversion Method Treasury Funded',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description: 'enter VRYNT Credit to VRYNT Convertion Method Supply Funded',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description: 'enter VRYNT Credit In activity Fee',
  })
  @IsOptional()
  @IsNumber()
  ...
  @Field((type) => Int, {
    nullable: true,
    description: 'enter Credit Purchase Component Holding',
  })
  @IsOptional()
  @IsNumber()
...
@InputType()
export class UpdateMetamaskAddressByIdDto {
  @Field({ nullable: true, description: 'enter the metamask address' })
  @IsString()
  @IsNotEmpty()
  readonly metamaskAddress: string;
}
